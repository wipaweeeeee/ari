...
var fetch_image_exports = {};
__export(fetch_image_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(fetch_image_exports);
...
var handler = async (event) => {
  ...
  try {
    let response = await axios_default.get(`https://drive.google.com/uc?export=download&id=${fileId}`, {
    ...
    if (contentType?.includes("text/html")) {
      response = await axios_default.get(`https://drive.google.com/uc?export=view&id=${fileId}`, {
        responseType: "arraybuffer"
      });
    }
