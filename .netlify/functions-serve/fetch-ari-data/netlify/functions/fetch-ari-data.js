...
var fetch_ari_data_exports = {};
__export(fetch_ari_data_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(fetch_ari_data_exports);
...
var handler = async () => {
  ...
  const url2 = `https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values/${RANGE}?key=${API_KEY}`;
  try {
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=fetch-ari-data.js.map
